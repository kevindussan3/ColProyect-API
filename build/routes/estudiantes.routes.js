...
var estudiantesCtrl = _interopRequireWildcard(require("../controllers/estudiantes.controller"));
...
router.get('/', estudiantesCtrl.getActivitys); // router.post('/:idUser&:idGrade&:idMatter', estudiantesCtrl.uploadActivity)
